// Segment cells of VisiumHD H&E Slide 
// 
...
def saveResultTable               = 0 

// ===================  File paths  ==========================================================================
def scalefactors_json = 'scalefactors_json.json' 
def csvfile = 'tissue_positions.csv' 
def resultsSubFolder = 'results_folder' 
...
// Stardist parameters 
var StarDistPathModel = 'dsb2018_heavy_augment.pb'
var param_threshold    = 0.1 // threshold for detection. All cells segmented by StarDist will have a detection probability associated with it, where higher values indicate more certain detections. Floating point, range is 0 to 1. Default 0.5
...
def PixelClassifier = "epithel_region_moderate" 	// To add to results

// Whole tissue classifier
def wholeTissueClass = "WholeTissue" 
def WholeTissueClassifier = "WholeTissue_Classifier_Moderate"    // name of WholeTissue pixel classifier
def WholeTissue_MinSize =  500          // Minimal WholeTissue connected-component size        
def WholeTissue_MinHoleSize = 40       // minmal hole size to keep when creating WholeTissue regions, samller holes are filled 

// Anatomical region classifier
def AnatomicalRegionsPixelClassifier = "epithel_region_moderate" 
def ClassNameForAnatomicalRegions = "epithel" 
...
AnatomicalRegionsExpansionMicrons  = [2]	// [7, 2]

// Nuclei object classifier
